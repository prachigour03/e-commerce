        ...
        <div className='flex-1'>
          ...
          <div className='flex justify-between text-base sm:text-2xl mb-4'>
            ...
            <select onChange={(e)=>setShortType(e.target.value)} className='border-2 border-gray-300 text-sm px-2'>
              <option value='relavent'>Shot by: Relavent</option>
              <option value='low-high'>Shot by: Low to High</option>
              <option value='high-low'>Shot by: High to Low</option>
            </select>
          </div>
